...
const Header = () => {
  ...
  return (
    <header className="fixed flex items-center justify-between z-50 top-0 left-0 right-0 p-2 bg-window shadow">
      ...
      <button
        className="px-2 sm:px-4 py-2.5 bg-nureply-blue text-sm font-semibold text-white rounded-md shadow-sm hover:bg-nureply-blue/75 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-background"
