...
const Preview = () => {
  return (
    <div className="w-full rounded-lg border-2 border-gray-500 max-sm:pb-8">
      ...
      <div className="m-5">
        <div>{"Hey,"}</div>
        <div>
          We started using professional email signatures! Some say they can
          alarm deliverability filters, though.
        </div>
        <span>-----</span>
      </div>
      <div className="p-4">
